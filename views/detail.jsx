    ...
    return (
      <DefaultLayout title={prop.addr} user={user} page={'detail'}>
        ...
        <div className="detailPage">
          ...
          {prop.la && prop.la.tel?
          <div className="detailLa">
            <div className="detailLaInfo">
              <div className="detailAgNm">{prop.la.agnt[0].nm}</div>
            </div>
            <a href={'tel:'+prop.la.tel} className="btn">Call {prop.la.tel} to know more</a>
          </div>
          :null}
        </div>
